...
# The projects class is a high-level module and BackendDevelopers & FrontendDevelopers are the low-level modules. In this example, we found that the high-level module depends on the low-level module. Hence this example are violated the Dependency Inversion Principle. 
