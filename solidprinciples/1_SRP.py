...
class AccountDB:
    ...
    def get_account_info(self, data):
        return f"Account information of user: {data}."

    # Store account details in to tables
    def save_account_info(self, data):
        return f"Store account details: Account No: {data}"    
...
class Account:
    ...
    def get_account_details(self):
        return f"{self._db.get_account_info(self.user_id)}"

    def save_account_details(self):
        return f"{self._db.save_account_info(self.account_no)}"  
